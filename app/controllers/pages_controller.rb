class PagesController < ApplicationController
  ...
  def send_message
    ...
    ActionMailer::Base.mail(from: params[:email], to: Rails.configuration.x.admin_email, subject: 'Message from postvite user', body: "#{params[:name]} wrote the following message:\n\n" + params[:message]).deliver_now
